        ...
        <div class="col-lg-3 col-md-6">
            <div class="ibox bg-info color-white widget-stat">
                <div class="ibox-body">
                    ...
                    <div class="m-b-5">NEW USERS</div><i class="ti-bar-chart widget-stat-icon"></i>
                    ...
                    <ul class="media-list media-list-divider m-0">
                        <li class="media">
                            <a class="media-img" href="javascript:;">
                                <img class="img-circle" src="{{ asset('admintheme/img/users/u1..jpg') }}" width="40" />
                            </a>
                        ...
                        <li class="media">
                            <a class="media-img" href="javascript:;">
                                <img class="img-circle" src="{{ asset('admintheme/img/users/u2..jpg') }}" width="40" />
                            </a>
                            <div class="media-body">
                        ...
                        <li class="media">
                            <a class="media-img" href="javascript:;">
                                <img class="img-circle" src="{{ asset('admintheme/img/users/u3..jpg') }}" width="40" />
                            </a>
                            <div class="media-body">
                        ...
                        <li class="media">
                            <a class="media-img" href="javascript:;">
                                <img class="img-circle" src="{{ asset('admintheme/img/users/u6..jpg') }}" width="40" />
                            </a>
                            <div class="media-body">
            ...
            <div class="ibox">
                ...
                <div class="ibox-body">
                    <ul class="media-list media-list-divider m-0">
                        <li class="media">
                            <a class="media-img" href="javascript:;">
                                <img src="{{ asset('admintheme/img/image..jpg') }}" width="50px;" />
                            </a>
                            <div class="media-body">
...
@endsection
@section('scripts')
<script src="{{ asset('admintheme/js/scripts/dashboard_1_demo.js') }}" type="text/javascript"></script>
@stop