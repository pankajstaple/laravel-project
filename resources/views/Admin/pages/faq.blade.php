             ...
             <div class="row">
                <div class="col-sm-12 form-group">
                    <div class="input-group">
                        <a class="btn btn-primary add-coupon-btn" href="{{URL('/admin/pages/addfaq')}}">+ ADD NEW</a>
                    </div>
                </div>
             </div>
            ...
            <table class="table table-striped table-bordered table-hover" id="users-table" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ URL('/admin/pages/updatefaq/'.base64_encode($faq->id))}}"  class="editfaq">
                                <i class="fa fa-edit"></i>
                            </a>
                            <form action="{{ route('deletefaq', base64_encode($faq->id)) }}" method="get" class="TypeDeleteForm disp-inline">
                                @csrf
