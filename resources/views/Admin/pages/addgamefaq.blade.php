 ...
 <div class="row">
	<div class="col-md-12">
	    <div class="ibox">
	        ...
	        <div class="ibox-head">
	            <div class="ibox-title">Add New game Faq</div>
	        </div>
	        <div class="ibox-body" style="">
	        	@if(isset($faq->id))
	        	<form class="form-vertical" action="{{URL('/admin/pages/updategamefaq/'.base64_encode($faq->id))}}" method="post" role="form"
                  id="AddFaqForm" enctype="multipart/form-data">
                  @method('PATCH')
                @else
                      	<form class="form-vertical" action="{{URL('/admin/pages/addgamefaq')}}" method="post" role="form"
                  id="AddFaqForm" enctype="multipart/form-data">
                  @method('PUT')
      			@endif
                {{csrf_field()}}
