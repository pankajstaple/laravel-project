...
<div class="page-content fade-in-up">
    <div class="ibox">
        ...
        <div class="ibox-head">
            <div class="ibox-title">Query Messages</div>
        </div>
        <div class="ibox-body">
            ...
            <table class="table table-striped table-bordered table-hover" id="users-table" cellspacing="0" width="100%">
                ...
                <tbody>
                	...
                	<tr>
                        ...
                        <td>{{ (!empty($message->created_at)?\Carbon\Carbon::parse($message->created_at)->format('m/d/Y H:i:s'):"")}}</td>
            ...
            {{ $all_messages->appends($_GET)->links() }}
        </div>
