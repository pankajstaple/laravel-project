  ...
  $.fn.imageuploadify = function(opts) {
    ...
    this.each(function() {
      ...
      <div class="imageuploadify well">
        ...
        <button type="button" class="btn btn-default add_image_btn"><span class="fa fa-camera" style="font-size:16px;"></span> Add images</button>
        </div>
      </div>
      `);
      ...
      if(totalFiles.length > 5){
        $(".image_error").show();
        $(".image_error").text('You have upload only 5 file');
        return false;
      }
        ...
        if (file.type && file.type.search(/image/) != -1) {
          ...
          // add file validation when image greter then 10 mb;
            $file_size_in_mb = file.size / 1000000;
          
            if($file_size_in_mb > 10){
              $(".image_error").show();
              $(".image_error").text('You should upload file less the 10 MB.');
              return false;
            }
          ...
          $(".image_error").show();
          $(".image_error").text('You should upload jpg,png and jpeg files.');
          return false;
      ...
      $(self).closest("form").on("submit", function(event) {
        ...
        if(totalFiles.length == 0){
          $(".image_error").show();
          $(".image_error").text('This field is requied.');
          return false;
        }
        ...
        if($(".description").val() == ''){
          $(".msg_error").show();
          $(".msg_error").text('This field is requied.');
          return false;
        }
        

    //   $.ajax({
    //   url: 'http://localhost/bedadstrong/public/weighin/4',
    //   data: formData,
    //   type: 'post',
    ...
    // });
      ...
      // $(".loader").show();
        ...
        // xhr.setRequestHeader("_token", $('meta[name="csrf_token"]').attr('content'));   
